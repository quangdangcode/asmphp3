...
@section('content')
    <form action="{{ route('registerBehail') }}" method="post">
        @csrf
        <div class="container mb-3">
            <h1>Đăng ký</h1>
            <p>Vui lòng điền vào mẫu này để tạo tài khoản.</p>
            <hr>
            <label for="use_name" class="form-label"><b>Tên tài khoản</b></label><br>
            <input type="text" class="form-control w-50" placeholder="Tên tài khoản" name="use_name" id="name" value="{{ old('use_name') }}">
            @error('use_name')
